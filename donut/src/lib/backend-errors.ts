...
export function translateBackendError(t: TFunction, err: unknown): string {
  ...
  switch (parsed.code) {
    ...
    case "MARINE_NO_CDP":
      return t("backendErrors.marineNoCdp");
    case "MARINE_GRAB_TIMEOUT":
      return t("backendErrors.marineGrabTimeout");
    case "MARINE_GRAB_FAILED":
      return t("backendErrors.marineGrabFailed", {
        detail: parsed.params?.message ?? "",
      });
    case "MARINE_NO_BRAND":
      return t("backendErrors.marineNoBrand");
    case "MARINE_OPENAI_NOT_CONFIGURED":
      return t("backendErrors.marineOpenaiNotConfigured");
    case "MARINE_OPENAI_KEY_MISSING":
      return t("backendErrors.marineOpenaiKeyMissing");
    case "MARINE_GENERATE_FAILED":
      return t("backendErrors.marineGenerateFailed", {
        detail: parsed.params?.message ?? "",
      });
    case "MARINE_GENERATE_TIMEOUT":
      return t("backendErrors.marineGenerateTimeout");
    case "MARINE_FILL_FAILED":
      return t("backendErrors.marineFillFailed", {
        detail: parsed.params?.message ?? "",
      });
